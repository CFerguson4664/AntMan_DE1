...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dspba_library_package.vhd" -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/dspba_library.vhd"         -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/unnamed_CORDIC_0.vhd"      -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
